...
public class MultiDimSpringArray {
    ...
    public static void main(String[] args) {
        ...
        String[][] userData = {{"Teodora Tsvetanov", "TeodorasPWD12"}, {"Anna Ziyayeva", "AnnaAlmaty123"}, {"Parvin Altae", "ParvinVienna321"}};
