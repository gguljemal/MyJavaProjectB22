...
public class WrapperClassMethods {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Double.compare(5, 1)); //first is larger than second one so= 1
        System.out.println(Double.compare(5, 5)); //first and second is equal = 0
        System.out.println(Double.compare(5, 45));//first number is smaller than second one = -1
